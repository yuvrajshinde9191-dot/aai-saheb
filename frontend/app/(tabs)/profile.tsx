...
export default function ProfileScreen() {
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            ...
            Alert.alert(
              'यशस्वी / Success',
              'तुम्ही यशस्वीरित्या लॉग आउट झाला आहात / You have successfully logged out',
              [{ text: 'ठीक आहे / OK', onPress: () => router.replace('/auth') }]
            );
          }
        },
      ]
  ...
  const handleNavigation = (route: string) => {
    Alert.alert(
      'विकसित होत आहे / Under Development',
      `"${route}" वैशिष्ट्य लवकरच उपलब्ध होईल / "${route}" feature will be available soon`,
      [{ text: 'ठीक आहे / OK' }]
    );
  };
  ...
  const profileSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          onPress: () => handleNavigation('Role Settings'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          onPress: () => handleNavigation('SOS Settings'),
        },
        {
          icon: 'people',
          title: 'विश्वसनीय संपर्क',
          subtitle: 'Trusted Contacts',
          onPress: () => handleNavigation('Trusted Contacts'),
        },
        {
          icon: 'lock-closed',
